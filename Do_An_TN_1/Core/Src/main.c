...
#include "Fuzzy_KA_01.h"  // Thư viện Fuzzy Controller
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	if (htim -> Instance == TIM8){
		...
		//Xử lí luật điều khiển
	     ...
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 3 , Temp_01, 0, 3, 1);  // Rule 4 (0 0 1)
	     ...
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 7 , Temp_01, 1, 2, 2);  // Rule 8 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 8 , Temp_01, 1, 3, 2);  // Rule 9 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 9 , Temp_01, 1, 4, 3);  // Rule 10 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 10, Temp_01, 2, 0, 1);  // Rule 11 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 11, Temp_01, 2, 1, 2);  // Rule 12 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 12, Temp_01, 2, 2, 2);  // Rule 13 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 13, Temp_01, 2, 3, 2);  // Rule 14 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 14, Temp_01, 2, 4, 3);  // Rule 15 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 15, Temp_01, 3, 0, 1);  // Rule 16 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 16, Temp_01, 3, 1, 2);  // Rule 17 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 17, Temp_01, 3, 2, 2);  // Rule 18 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 18, Temp_01, 3, 3, 3);  // Rule 19 (0 0 1)
	     ...
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 21, Temp_01, 4, 1, 3);  // Rule 22 (0 0 1)
	     Rule(ID1, ID2, OUT_01, Value_ID_1, Value_ID_2, 22, Temp_01, 4, 2, 3);  // Rule 23 (0 0 1)
	     ...
	     // Xuất xung PWM
	     __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_1, Output_PWM_Fuzzy);

	     // Gán lại sai số
	     	pt_Para_MR->ek_1 = pt_Para_MR->ek;
